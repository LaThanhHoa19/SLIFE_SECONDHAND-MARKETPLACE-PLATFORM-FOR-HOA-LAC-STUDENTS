  ...
  const columns = useMemo(
      () => [
        ...
        },
        {
          ...
          width: 108,
          render: (row) => (
              <Chip label={String(row.targetType || '—').toUpperCase()} size="small" sx={{ ...targetTypeChipSx(row.targetType), height: 24 }} />
          ),
        },
        {
          id: 'reporterName',
        ...
        <Stack direction="row" justifyContent="space-between" alignItems="flex-start" flexWrap="wrap" gap={2} sx={{ mb: 2.5 }}>
          <Box>
            ...
            <Typography variant="body2" sx={{ color: 'rgba(203, 213, 225, 0.85)', maxWidth: 520, lineHeight: 1.55 }}>
              Phân loại theo loại hình; lọc theo trạng thái. Tổng hiện tại:{' '}
