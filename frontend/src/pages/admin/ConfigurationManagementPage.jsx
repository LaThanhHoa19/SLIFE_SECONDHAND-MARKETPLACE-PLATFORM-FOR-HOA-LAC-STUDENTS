...
const CONFIG_LABELS = {
    ...
    DEAL_TIMEOUT_UNIT: 'Đơn vị thời gian tự động chuyển sang đã bán (NGÀY / PHÚT)',
...
const CONFIG_HELPERS = {
    ...
    DEAL_TIMEOUT_UNIT: 'Chọn đơn vị ngày hoặc phút cho thời gian tự động chuyển sang đã bán.',
...
const DISPLAY_DESCRIPTION_OVERRIDES = {
    ...
    DEAL_TIMEOUT_UNIT: 'Đơn vị thời gian dùng cho cấu hình tự động chuyển sang đã bán.',
