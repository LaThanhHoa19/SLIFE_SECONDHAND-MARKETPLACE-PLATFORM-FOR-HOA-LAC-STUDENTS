...
export default function LoginPage() {
  ...
  return (
      ...
      >
        ...
        >
          <Typography sx={{ color: '#A78BFA', fontWeight: 700, fontSize: '1.95rem', letterSpacing: '0.02em' }}>
            Slife
          </Typography>
        </Box>
        ...
        >
          ...
          <Box sx={{ mt: 3, mb: { xs: 3, md: 4 }, textAlign: 'center' }}>
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5} justifyContent="center">
              <Box sx={{ minWidth: 190, px: 2, py: 1.5, borderRadius: 3, border: '1px solid rgba(167,139,250,0.24)', bgcolor: 'rgba(157,110,237,0.12)', display: 'flex', gap: 1, alignItems: 'center' }}>
                <BoltIcon sx={{ color: '#a78bfa', fontSize: 18 }} />
                <Box sx={{ textAlign: 'left' }}>
                  <Typography sx={{ color: 'rgba(255,255,255,0.66)', fontSize: '0.72rem', letterSpacing: '0.08em' }}>TỐC ĐỘ</Typography>
              ...
              <Box sx={{ minWidth: 190, px: 2, py: 1.5, borderRadius: 3, border: '1px solid rgba(167,139,250,0.24)', bgcolor: 'rgba(157,110,237,0.12)', display: 'flex', gap: 1, alignItems: 'center' }}>
                ...
                <Box sx={{ textAlign: 'left' }}>
                  <Typography sx={{ color: 'rgba(255,255,255,0.66)', fontSize: '0.72rem', letterSpacing: '0.08em' }}>UY TÍN</Typography>
